...
#include "srtSceneWidgetPlugin.h"
...
{
  qsrt::SceneWidget *wdgPtr = new qsrt::SceneWidget(parent);
  qsrt::Scene *sc = new qsrt::Scene(wdgPtr);
...
QString SceneWidgetPlugin::whatsThis() const
{
  return "This srtSceneWidget displays a photo-realistic image of an algebraic surface in "
    "three-dimensional space. Please refer to the reference documentation of libsrt "
    "and libqsrt for more information.";
}
...
QString SceneWidgetPlugin::domXml() const
{
    return "<ui language=\"c++\">\n"
           " <widget class=\"qsrt::SceneWidget\" name=\"sceneWidget\">\n"
